...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/slider1.jpg" height="450px" class="d-block w-100" alt="...">
            </div>
    ...
    <div class="container my-3" id="ques">
        <h2 class="text-center text-success"> iDiscuss - Browse Categories</h2>
        <div class="row">

            <!-- Fetch all the Categories and Use a For Loop to interact through Categories -->
            <?php
            ...
            while($row = mysqli_fetch_assoc($result)){
             ...
             echo '<div class="col-md-4 my-3">
                <div class="card" style="width: 18rem;">
                    <img src="images/card'.$id. '.jpg" height="180" class="card-img-top" alt=" image for this category ">
                    <div class="card-body">
